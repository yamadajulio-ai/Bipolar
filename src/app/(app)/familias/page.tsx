...
export default function FamiliasPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
            ...
            <Card key={mod.id}>
              ...
              {isOpen && (
                <div id={`module-${mod.id}`} className="mt-4 space-y-4">
                  ...
                  {/* When to seek help */}
                  <div className="rounded-lg bg-warning-bg-subtle border border-warning-border p-3">
                    <p className="text-xs font-semibold text-warning-fg mb-1">Quando procurar ajuda profissional</p>
                    <p className="text-xs text-warning-fg">{mod.whenToSeekHelp}</p>
                  </div>
                </div>
              )}
            </Card>
      ...
      {/* Emergency contacts */}
      <Card className="mt-6 bg-danger-bg-subtle border-danger-border">
        <h2 className="text-sm font-bold text-danger-fg mb-2">Emergências</h2>
        <div className="grid grid-cols-3 gap-2 text-center">
          <a href="tel:188" className="rounded-lg bg-surface border border-danger-border p-2 no-underline">
            <p className="text-lg font-bold text-danger-fg">188</p>
            <p className="text-[11px] text-danger-fg">CVV (24h)</p>
          </a>
          <a href="tel:192" className="rounded-lg bg-surface border border-danger-border p-2 no-underline">
            <p className="text-lg font-bold text-danger-fg">192</p>
            <p className="text-[11px] text-danger-fg">SAMU</p>
          </a>
          <a href="tel:190" className="rounded-lg bg-surface border border-danger-border p-2 no-underline">
            <p className="text-lg font-bold text-danger-fg">190</p>
            <p className="text-[11px] text-danger-fg">Polícia</p>
          </a>
        </div>
      </Card>
