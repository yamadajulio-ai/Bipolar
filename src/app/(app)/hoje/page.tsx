...
const moodLabels: Record<number, { text: string; color: string }> = {
  1: { text: "Muito deprimido", color: "text-red-600 dark:text-red-400" },
  2: { text: "Deprimido", color: "text-orange-600 dark:text-orange-400" },
  3: { text: "Estável", color: "text-emerald-700 dark:text-emerald-400" },
  4: { text: "Elevado", color: "text-amber-600 dark:text-amber-400" },
  5: { text: "Muito elevado", color: "text-red-600 dark:text-red-400" },
};

const energyLabels: Record<number, { text: string; color: string }> = {
  1: { text: "Muito baixa", color: "text-red-600 dark:text-red-400" },
  2: { text: "Baixa", color: "text-orange-600 dark:text-orange-400" },
  3: { text: "Normal", color: "text-emerald-700 dark:text-emerald-400" },
  4: { text: "Alta", color: "text-amber-600 dark:text-amber-400" },
  5: { text: "Muito alta", color: "text-red-600 dark:text-red-400" },
};
