...
export default function PlanejadorPage() {
  ...
  return (
    <div>
      ...
      <Link href="/integracoes" className="mb-6 flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2.5 no-underline transition-colors hover:bg-blue-100">
        ...
        <span className="text-sm font-medium text-blue-700">Sincronizar com Google Agenda</span>
      </Link>
