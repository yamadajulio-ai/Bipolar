      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-border bg-surface p-6 shadow-sm">
          ...
          <div className="space-y-4 text-sm text-muted">
            <p>
              Se você criou sua conta com <strong>e-mail e senha</strong>, entre
              em contato pelo Instagram{" "}
              <a
                href="https://instagram.com/suportebipolar"
                target="_blank"
            ...
            <p>
              Em breve teremos recuperação automática por e-mail.
            </p>
          </div>
