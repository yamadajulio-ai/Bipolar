      ...
      <main className="mx-auto max-w-3xl flex-1 px-4 py-8">
        ...
        <section className="mb-6">
          ...
          <p className="text-sm text-muted">
            O Empresa Bipolar é uma plataforma educacional e de auto-organização. Todo o conteúdo
        ...
        <section className="mb-6">
          ...
          <p className="text-sm text-muted">
            O Empresa Bipolar não se responsabiliza por decisões tomadas com base no conteúdo
        ...
        <section className="mb-6">
          ...
          <p className="text-sm text-muted">
            Dúvidas sobre estes termos: <strong>contato@empresabipolar.com.br</strong> (placeholder).
          </p>
        </section>
      </main>
      <Footer />
