        ...
        {contacts.map((contact, i) => (
          <div key={i} className="mb-3 flex gap-2">
            <input
              ...
              placeholder="Nome"
              className="flex-1 rounded-md border border-control-border bg-surface px-3 py-2 text-sm text-foreground placeholder:text-muted focus-visible:border-primary focus-visible:outline-none"
            />
            <input
              type="tel"
              value={contact.phone}
